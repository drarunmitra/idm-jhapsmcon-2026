...
<!-- TODO: insert PNG screenshot of Home panel, alt: "AMCHSS dashboard home page with value boxes, choropleth maps and 14-day epi curve" -->
...
<!-- TODO: insert PNG of the 3D plotly Rt ribbon -->
...
<!-- TODO: insert PNG of Projections panel -->

State selector → 15-day forward forecast of daily incidence using `projections::project()` — branching-process simulation seeded with the recent log-linear fit.
